...
def validate_data(age, investment_amount, intent_request):
    ...
    if age is not None:
        age = parse_int(age)
        if age < 0:
            return build_validation_result(False, "age", "The age needs to be positive, please provide a positive number.")
        elif age >= 65:
            return build_validation_result(False, "age", "To use this service, you must be under 65 years old. Please provide a valid age.")
    ...
    if investment_amount is not None:
        ...
        if investment_amount < 5000:
            return build_validation_result(False, "investmentAmount", "The minimum investment amount is $5000. Please provide a valid amount.")
...
def recommend_portfolio(intent_request):
    ...
    recommendation = investment_recommendation(risk_level)
    ...
    return close(
        ...
        'Fulfilled',
        {
            ...
            'content': f'{first_name} thank you for the information. According to your risk level, my recommendation is {recommendation}'
        }
        )
